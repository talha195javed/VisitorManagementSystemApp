...
const CaptureVisitorPhoto = ({ route }) => {
    ...
    const uploadPhoto = async () => {
        ...
        try {
            ...
            const response = await fetch('http://10.0.2.2:8000/api/visitor/storeAppCapturedIDImage', {
                method: 'POST',
                headers: {
            ...
            if (response.ok) {
                ...
                if (visibleScreens.includes('emergency_contact')) {
    ...
    return (
        <ImageBackground source={require('../assets/images/checkin6.jpg')} style={styles.background}>
            <View style={styles.container}>
                <Text style={styles.title}>Capture Visitor ID Photo</Text>
                <Text style={styles.subtitle}>Align your ID in front of camera and click the button to capture.</Text>
